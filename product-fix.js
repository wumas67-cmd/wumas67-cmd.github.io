(() => {
  ...
  function productImage(compact = false) {
    return `<div class="product-visual${compact ? ' compact' : ''}" style="background:#e8e1d1">
      ...
      <img class="medicine-buddha-photo" src="${product.image}?v=20260916-3" alt="藥師佛藥香2H產品實物照片" style="width:100%;height:100%;object-fit:cover;display:block;position:relative;z-index:1">
    </div>`;
  }
